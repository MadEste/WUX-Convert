...
using Verify = Microsoft.CodeAnalysis.CSharp.CodeFix.Testing.MSTest.CodeFixVerifier<
    Prototype_Fixes.Prototype_FixesAnalyzer,
    Prototype_Fixes.Prototype_FixesCodeFixProvider>;
...
namespace Prototype_Fixes.Test
{
    ...
    namespace ConsoleApplication1
    {
        ...
        {   
            ...
            var expected = Verify.Diagnostic("Prototype_Fixes").WithLocation(11, 15).WithArguments("TypeName");
